...
def delete_with_xl(Sector, NodeID):
    return

# write a function to add a component to the new sector
def add_to_new_sector(SourceSector,SourceNodeIndex):
    return


def importSectors( filepath='' ):
    ...
    outpath = os.path.join(project,'source\\resources')
